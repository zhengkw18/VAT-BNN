...
if __name__ == "__main__":
    ...
    config = 'basebnn_batch-{}_epochs-{}_dataset-{}_labelnum-{}'.format(args.batch_size, args.epochs, args.dataset, args.label_num)
    ...
    if args.do_train:
        ...
        for epoch in range(args.epochs):
            print(f"Epoch: {epoch}")
            train_loss, train_acc = train_epoch(model, labeled_train_loader, mu_optimizer, psi_optimizer, device)
